...
<div align="right"><a href="category.brand.ui.php?type=add">Add</a></div>
<table align="center" class="mytable" id="table" height="70%"   cellpadding="1" cellspacing="1">
    ...
    $row=1;
        ...
        ?>
        <tr  onclick="click2edit(<?=$c["brand_id"];?>,'edit');" onmouseover="this.style.backgroundColor='violet';" onmouseout="this.style.backgroundColor='white';" >
            ...
            <td style="padding:0px; border-bottom:1px solid #ccc; border-right:1px solid #ccc; border-color:#003366;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $c["brand_name"];?></td>
            <td style="padding:0px; border-bottom:1px solid #ccc; border-right:1px solid #ccc; border-color:#003366;" align="center"><?php echo $c["active"]?></td>  
        </tr>
    <?php }?>
</table>
...
<script type="text/javascript">       
      function click2edit(id,typer){    
		 parent.parent.location.href ="category.brand.ui.php?id="+id+"&type="+typer;  
      }
</script>
