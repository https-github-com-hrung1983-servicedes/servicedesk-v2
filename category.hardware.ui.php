...
<table align="center" class="mytable" id="table" height="70%"   cellpadding="1" cellspacing="1">
    <tr>
        <td valign="top" align="center">
            <form action="category.execute.php"  method="post"  name="form1" id="form1"  >
			...
			<input class="form-control"   type="hidden" value="<?php echo $id?>" name="id" id="id" />
                    ...
                    <tr>
					 ...
					 <tr>
                      ...
                      <td height="25" bgcolor="white" width="70%" align="left" class="fontBblue"> 
                        <input class="form-control"  type="text" value="<?php echo $c["cate_name"];?>" id="catedesc" name="catedesc"  style="width:350pt" colspan="2">
                      </td>
                    </tr>
					<tr>
			   ...
			   <select name="stractive" id="stractive" style="width:250pt" >
                                    <option value="y" <?php if($c["cate_active"]=="y") echo "selected";?>>Y</option>
                                   <option value="n" <?php if($c["cate_active"]=="n") echo "selected";?>>N</option>
                         </select></td>
		    </tr>
