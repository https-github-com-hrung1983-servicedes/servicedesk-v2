    ...
    <tr>                                               
        ...
        <? if($id!=""){?>
			...
			<a href="#" onclick="cdp1.showCalendar(this, 'dte'); return false;" > 
                ...
                <td height="20" align="center"><input class="form-control"  type="text" name="other_seq" id="other_seq" style="width:80pt;" readonly="readonly" ></td>
                ...
                <td height="20" align="center"><input class="form-control"  type="text" name="bill_no" id="bill_no" style="width:140pt;"></td>       
                <td height="20" align="center"><input class="form-control"  type="text" name="bill_total" id="bill_total" style="direction:rtl;width:100pt;"></td>       
                <td height="20" width="13%" align="center"><input class="form-control"  type="text" name="bill_total_all" id="bill_total_all" style="direction:rtl;width:110pt;"></td> 
                ...
                <?if($status_check == ""){?>                
                    ...
                    <input class="form-control"  name="Submit"  type="image" onclick="return chkDetail();"  src="image/save.jpg" alt="Save" align="right" width="18" height="18" />
                <?}?>
                </td>           
           </tr>  
           ...
           <input class="form-control"  type="hidden" value="<?=$tot;?>" name="tot" id="tot">                                                                          
               <tr>
                ...
                <td height="20" align="center" ><input class="form-control"  type="text" readonly="readonly" value="<?=$tttot?>" name="total_funds" id="total_funds" style="direction:rtl;"></td> 
