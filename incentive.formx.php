    ...
    <tr>                                               
        ...
        <? if($id!=""){?>
			...
			<a href="#" onclick="cdp1.showCalendar(this, 'dte'); return false;" > 
                ...
                <td width="7%" height="20" align="center"><nobr><input type="text" name="site_id" id="site_id" style="width:80pt;"></td>
                <td width="8%" height="20"><input type="text" name="location_from" id="location_from" style="width:110pt;"></td>
                <td width="10%" height="20"><input type="text" name="location_to" id="location_to" style="width:110pt;"></td>       
                <td width="7%" height="20" align="center"><input type="text" name="distance_from" id="distance_from" style="direction:rtl;width:50pt;"></td>       
                <td width="7%" height="20" align="center"><input type="text" name="distance_to" id="distance_to" style="direction:rtl;width:50pt;"></td>  
                <td width="7%" height="20" align="center"><input type="text" name="distance_result" id="distance_result" readonly="readonly" style="direction:rtl;width:50pt;"></td>  
                <td width="7%" height="20" align="center"><input type="text" name="express_" id="express_" style="direction:rtl;width:50pt;"></td>  
                <td width="24%" height="20" align="center"><input type="text" name="description" id="description" style="width:300pt;"></td>         
