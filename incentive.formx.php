...
if(!checkUser()){    echo Message(35,"red","ข้อความเตือน","คุณยังไม่ได้กรอกชื่อและรหัสผ่านครับ","<a href='index.php?link=incentive.formx'> เข้าสู่ระบบ </a>");
   exit;
}
$id = $_REQUEST["id"];
$type = $_REQUEST["type"];  
    ...
    <tr>                                               
            ...
            <input class="form-control"  type="hidden" value="<?=$id?>" name="id" id = "id">                            
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytable" border="1" bordercolor="#FF0000">
                    ...
                    <tr>
                       ...
                       <?if($type=="edit"){?> <td align="left">&nbsp;
                       <a href="incentive.clear.php?id=<?=$id?>&type=edit" ><img src="image/addedit.png" alt="Print" width="20" height="18" border="0" align="right" /> </a></td>
                       <td align="left"><b> เคลียร์ใบเสร็จ </b>&nbsp;</td>  <?}?>
                       <td align="left">
                       ...
                       <td align="left">
                            <? if($status_check == ""){?><b>บันทึก</b><?}?></td>                       
                       <td><a href="incentive.ot.list.php" ><img src="image/cancel.jpg" alt="Cancel" width="20" height="18" border="0" align="left" /> </a> </td>
                ...
                <table width="80%" align="center" id="table" cellpadding="1" cellspacing="1" border="1">                       
                    ...
                    <tr>
                        ...
                        <td width="15%" class="fontBblue" align="center"><input class="form-control"  type="text" value="<?=$c["other_expenses_per"];?>" name="other_expenses_per" id="other_expenses_per" style="width:120pt;direction:rtl;"></td>        
                    </tr >
                     <tr>
                    ...
                    <tr>
                        ...
                        <td width="15%" class="fontBblue" align="center"><input class="form-control"  type="text" name="incentive_total" value="<?=$c["incentive_total"]?>" id="incentive_total" style="width:120pt;direction:rtl;"></td>       
                    </tr >
                    <tr>
        ...
        <? if($id!=""){?>
            ...
            <tr>
                ...
                <td width="7%" height="20" class="fontBblue" align="center">ระยะทางที่เดินทาง (กม.)</td>  
            ...
            <tr>
			<td width="7%" height="20" align="center"><nobr><input class="form-control"  type="text" name="dte" id="dte" value="<?=$dte?>" style="width:55pt;">
			<a href="#" onclick="cdp1.showCalendar(this, 'dte'); return false;" > 
                          <img src="image/calendar.png" width="17" height="13" border="0" /></td>
                <td width="7%" height="20" align="center"><nobr><input class="form-control"  type="text" name="site_id" id="site_id" style="width:80pt;"></td>
                <td width="8%" height="20"><input class="form-control"  type="text" name="location_from" id="location_from" style="width:110pt;"></td>
                <td width="10%" height="20"><input class="form-control"  type="text" name="location_to" id="location_to" style="width:110pt;"></td>       
                <td width="7%" height="20" align="center"><input class="form-control"  type="text" name="distance_from" id="distance_from" style="direction:rtl;width:50pt;"></td>       
                <td width="7%" height="20" align="center"><input class="form-control"  type="text" name="distance_to" id="distance_to" style="direction:rtl;width:50pt;"></td>  
                <td width="7%" height="20" align="center"><input class="form-control"  type="text" name="distance_result" id="distance_result" readonly="readonly" style="direction:rtl;width:50pt;"></td>  
                <td width="7%" height="20" align="center"><input class="form-control"  type="text" name="express_" id="express_" style="direction:rtl;width:50pt;"></td>  
                <td width="24%" height="20" align="center"><input class="form-control"  type="text" name="description" id="description" style="width:300pt;"></td>         
                <td width="6%" height="20" align="center">&nbsp;<? if($status_check == ""){?>  
           ...
           ?>                              
            <tr ondblclick="click2editdetail('<?=$c["id"]?>','<?=$c["dte"]?>','<?=$c["seq_id"]?>','<?=$c["site_id"]?>','<?=$c["location_form"]?>','<?=$c["location_to"]?>',<?=$c["distance_form"]?>,'<?=$c["distance_to"]?>','<?=$c["ditstance_result"]?>','<?=$c["express_position"]?>','<?=$c["jobdescription"]?>');" onmouseover="this.style.backgroundColor='violet';" onmouseout="this.style.backgroundColor='white';">
			   <td width="7%" height="20" align="center" class="fontBblue"><nobr>&nbsp;<?=$c["dte"]?></td>
                <td width="7%" height="20" align="center" class="fontBblue"><nobr>&nbsp;<?=$c["site_id"]?></td>
                <td width="8%" height="20" class="fontBblue">&nbsp;<?=$c["location_form"]?></td>
                <td width="10%" height="20" class="fontBblue">&nbsp;<?=$c["location_to"]?></td>       
                <td width="7%" height="20" align="center" class="fontBblue">&nbsp;<?=$c["distance_form"]?></td>       
                <td width="7%" height="20" align="center" class="fontBblue">&nbsp;<?=$c["distance_to"]?></td>  
                <td width="7%" height="20" align="center" class="fontBblue">&nbsp;<?=$c["ditstance_result"]?></td>  
                <td width="7%" height="20" align="center" class="fontBblue">&nbsp;<?=$c["express_position"]?></td>  
                <td width="24%" height="20" class="fontBblue">&nbsp;<?=$c["jobdescription"]?></td>
                <td width="6%" height="20" class="fontBblue" align="center">&nbsp;<? if($status_check == ""){?>
...
<script type="text/javascript"> 
    ...
    function CheckText() {
     ...
     function click2editdetail(id,dte,seq_id,site_id,location_form,location_to,distance_form,distance_to,ditstance_result,express_position,jobdescription){
