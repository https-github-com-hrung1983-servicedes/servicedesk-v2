...
<table width="100%" align="center" border="1" class="mytable" id="table" height="100%"   cellpadding="1" cellspacing="1">
    <tr>                                               
        ...
        <? if($id!=""){?>
		    ...
		    <input type="hidden" name="gasperkilo" id="gasperkilo" value="<?=$gasperkilo?>">
            ...
            <tr>
            <td width="7%" height="20" align="center"><nobr><input type="text" name="dte" id="dte" value="<?=$dte?>" style="width:55pt;" readonly onclick="cdp1.showCalendar(this, 'dte'); return false;"></td>
<td height="20" align="center"><nobr><input type="text" name="job_no" id="job_no" style="width:80pt;" 
				onclick="getJobNo()" readonly ></td>
                <td height="20" align="center"><nobr><input type="text" name="site_id" id="site_id" style="width:50pt;"></td>
                <td height="20"><input type="text" name="location_from" id="location_from" style="width:60pt;"></td>
                <td height="20"><input type="text" name="location_to" id="location_to" style="width:60pt;"></td>       
                ...
                <td height="20" align="center"><input type="text" name="express_" id="express_" style="direction:rtl;width:50pt;"></td>  
