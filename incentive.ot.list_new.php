            ...
            <form  method="post"   name="form1" id="form1"  action="#"  onSubmit="return false";>
                   ...
                   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytable">
                    <tr>
						...
						<a href="incentive.form_new.php?type=add" target="_parent">
                        <img src="image/add.JPG" alt="Add" width="20" height="20" border="0" align="right"> </a>
						<?}?>
						</td>
                        <td width="27" valign="middle">&nbsp;<b><? if($c_cnt_status["cnt"] <= 3  || $_SESSION['Ustate']=="cm" || $_SESSION['Ustate']=="admin"){
							?> <?=iconv( 'UTF-8', 'TIS-620', "เพิ่ม");?> <?}?></b></td>
                ...
                <table width="100%" align="center" class="mytable" id="table7"  cellpadding="1" cellspacing="1">
                    <tr>
                        ...
                        <th class="th" width="7%"><?=iconv( 'UTF-8', 'TIS-620', "เลขที่");?></th>
                        <th class="th" width="10%"><?=iconv( 'UTF-8', 'TIS-620', "ชื่อผู้เบิก");?></th>
                        <th class="th" width="25%"><?=iconv( 'UTF-8', 'TIS-620', "รายละเอียด");?></th>
                        <th class="th" width="8%"><?=iconv( 'UTF-8', 'TIS-620', "วันที่ขอเบิก");?></th>
                        <th class="th" width="7%"><?=iconv( 'UTF-8', 'TIS-620', "ค่าที่พัก");?></th>
                        <th class="th" width="7%"><?=iconv( 'UTF-8', 'TIS-620', "ค่าเบี้ยเลี้ยง");?></th>
                        <th class="th" width="7%"><?=iconv( 'UTF-8', 'TIS-620', "ค่าเดินทาง");?></th>
                        <th class="th" width="7%"><?=iconv( 'UTF-8', 'TIS-620', "ค่าใช่จ่ายอื่นๆ");?></th>
                        <th class="th" width="10%"><?=iconv( 'UTF-8', 'TIS-620', "รวม");?></th>
                    </tr >
                        <?  // echo $sql;
                       ...
                       <? }?>
                          <tr>
                            <td colspan="10" style="padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;"> <?=iconv( 'UTF-8', 'TIS-620', "จำนวน");?> <?=$i;?><?=iconv( 'UTF-8', 'TIS-620', "แถว");?></td>
                          </tr>
...
<script type="text/javascript">
    ...
    //alert(id);
         parent.parent.location.href ="incentive.form_new.php?id="+id+"&type="+typer;
      }
</script>
