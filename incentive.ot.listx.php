...
require_once("function.php");          
  ...
  if(!checkUser()){    echo Message(35,"red",$titel1,$msg1,"<a href='index.php?link=incentive.ot.listx'> $login </a>");
  exit;
  }                                                                                                      
...
include("header.php");   
   ...
   //if($Ustate=="user" || $Ustate=="helpdesk"){
        $sql .= " Where tbl_user_login.user_bss_id = '$Uid'  Order by  tbl_incentive_ot.id DESC";
//echo $sql;
 //  }
...
Where tbl_user_login.user_bss_id = '$Uid' 
            ...
            <form  method="post"   name="form1" id="form1"  action="#" target="mainPage" onSubmit="return false";> 
                   ...
                   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytable">
                    <tr>
                        ...
                        <td width="27" valign="middle">&nbsp;<b><? if($c_cnt_status["cnt"] == 0 ){?> เพิ่ม <?}?></b></td>
