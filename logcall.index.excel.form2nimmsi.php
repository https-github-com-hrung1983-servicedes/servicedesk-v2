...
require_once("function.php");          
  ...
  if(!checkUser()){    echo Message(35,"red",$titel1,$msg1,"<a href='index.php?link=logcall.index.excel.form2nimmsi'> $login </a>");
  exit;
  }                                                                                                      
...
$emp = $_REQUEST["emp"];
		 ...
		 $sql .= " Where tbl_log_call_center.fixed_time like '$dte%'  And tbl_log_call_center.type_service = 'MSI'";
...
if($typer=="2"){
		...
		$sql .= " And  tbl_log_call_center.job_no  like 'MSI%' ";
	}
        ...
        <td valign="top"> 
            <form  method="post"   name="form1" id="form1"  action="#" target="mainPage" onSubmit="return false";> 
			   ...
			   <b>&nbsp;Year :</b>
				...
				<?if($_SESSION["Uat"]=="MSI"){?>Job Type  :</b> 
...
<script type="text/javascript"> 
    ...
    function Search_Click(typer,months,years,job,emp){        
   			document.location.href ="logcall.index.excel.form2nimmsi.php?type="+typer+"&months="+months+"&years="+years+"&job="+job+"&emp="+emp;
      }
