            ...
            <form  method="post" name="form1" id="form1" action="#" target="_parent"> 
                ...
                <table width="60%" align="center" class="mytable" id="table7"  cellpadding="1" cellspacing="1">
                    <tr>              
                        ...
                        <th class="th" width="30%">ชื่อ</th>
                        <th class="th" width="10%">เบี้ยเลี้ยง</th>        
                        <th class="th" width="10%">ค่า Incentive</th>           
                        <th class="th" width="10%">ค่าที่พัก</th>           
                        <th class="th" width="10%">ค่าแก็ส</th>        
                        <th class="th" width="10%">ค่าทางด่วน และ อื่นๆ</th>        
