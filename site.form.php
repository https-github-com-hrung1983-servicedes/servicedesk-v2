...
<tr>
        ...
        <td height="20" align="left" class="fontBblue"><input type="text" name="Latitude" id="Latitude" value="<?=@$c['latitude'];?>"  style="width:200pt" /></td>
      </tr>
<tr>
        <td height="20" align="left" class="fontBblue"><nobr>Longtitude :</td>
        <td height="20" align="left" class="fontBblue"><input type="text" name="Longtitude" id="Longtitude" value="<?=@$c['longitude'];?>"  style="width:200pt" /></td>
      </tr>
      </table>
            </td>
