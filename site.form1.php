...
$(document).ready(function(){
	$("#Save").click(function(){        
			...
			$.post('function.execute.php',{ mode : "site.all", typer : typer, site_id : site_id ,site_old_name : site_old_name ,site_new_name  :  site_new_name, site_name : site_name , pos : pos , address : address , province_name : province_name , contact : contact , center_phase : center_phase,  from_center : from_center},
                ...
                <table width="70%" align="center"  id="table" cellpadding="1" cellspacing="1" border="0"  bgcolor="#FFFFFF">
				 ...
				 <tr>
					  ...
					  <select name="center_phase" id="center_phase" style="width:200pt" >  
					  	<option value="lp" <? if($c["center_phase"]=="lp") echo "selected";?>>ภาคกลาง</option>
					  	<option value="bn" <? if($c["center_phase"]=="bn") echo "selected";?>></option>
					  	<option value="cm" <? if($c["center_phase"]=="cm") echo "selected";?>></option>
					  	<option value="kk" <? if($c["center_phase"]=="kk") echo "selected";?>></option>
					  	<option value="skt" <? if($c["center_phase"]=="skt") echo "selected";?>></option>
					  	<option value="sr" <? if($c["center_phase"]=="sr") echo "selected";?>></option>
					  	<option value="stn" <? if($c["center_phase"]=="stn") echo "selected";?>></option>
					  </select>	
					  </td>
                 </tr>
				 <tr>
