...
where tbl_category_hardware.cate_id in ('1','3','4','6','7','8','9','10','11','12','13','16','36') limit 0,286"; 
...
<tr onmouseover=this.style.backgroundColor='violet'; onmouseout=this.style.backgroundColor='white';>                              
        <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'><?=$i?></td>            
        <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;'><?=$row[cate_name]?></td>         
        <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'>
		<a href='summary.serail.all.detail.php?id=<?=$row["cate_id"]?>&typer=active&site_type=NGV' target='blank'><?=getCntSerial($row[cate_id],$cate_id_retail,$brand_id_retail)?></a></td>
        <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'>
		<a href='summary.serail.all.detail.php?id=<?=$row["cate_id"]?>&typer=activetoengineer&site_type=NGV' target='blank'><?=getCntActiveToEngineer($row[cate_id],$cate_id_retail,$brand_id_retail)?></a></td> 
	    <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'>
		<a href='summary.serail.all.detail.php?id=<?=$row["cate_id"]?>&typer=onhand&site_type=NGV' target='blank'><?=getCntOnHand($row[cate_id],$cate_id_retail,$brand_id_retail)?></a></td>  
        <td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'>
		<a href='summary.serail.all.detail.php?id=<?=$row["cate_id"]?>&typer=repair&site_type=NGV' target='blank'><?=getCntRepair($row[cate_id],$cate_id_retail,$brand_id_retail)?></a></td>
      	<td  style='padding:0px; border-bottom:1px solid #ccc; border-right:0px solid #ccc;' align='center'>
		<a href='summary.serail.all.detail.php?id=<?=$row["cate_id"]?>&typer=scrap&site_type=NGV' target='blank'><?=getCntScrap($row[cate_id],$cate_id_retail,$brand_id_retail)?></a></td>     
</tr>
        <?  $i++;   }?>
...
$sql = "SELECT
				...
				And tbl_hardware_onhand_user.user_id not like '10%'
